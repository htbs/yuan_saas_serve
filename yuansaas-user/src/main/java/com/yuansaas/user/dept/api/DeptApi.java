...
public class DeptApi {
     ...
     */
    @GetMapping("/list")
    @SecurityAuth(permissions = "users:dept:find")
     ...
     */
    @PostMapping("/save")
    @SecurityAuth(permissions = "users:dept:create")
     ...
     */
    @PutMapping("/update")
    @SecurityAuth(permissions = "users:dept:update")
    ...
    @SecurityAuth(permissions = "users:dept:delete")
